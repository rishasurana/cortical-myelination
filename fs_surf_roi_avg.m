...
%    {default = []}
%  'absflag' - [0|1] whether minval should be a threshold for absolute values
%    {default = 0}
%
% Notes:
...
% last mod: 07/14/10 by Don Hagler
%
...
if ~isempty(parms.aparc)
  ...
  [aparc_roinums,aparc_names] = fs_read_annotation(parms.aparc);
