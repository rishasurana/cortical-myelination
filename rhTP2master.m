...
for folderNum = 3:length(direr)
    try
        ...
        rh = fs_read_surf(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/fs/surf/rh.white']);
        lh = fs_read_surf(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/fs/surf/lh.white']);
        newVectorsrh = surfAnalysis(rh);
        
        % loading meshes
        cd(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/fs/mri/'])
        try
        ...
        [volb, Mb, mr_parmsb, volszb] = fs_load_mgh(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/fs/mri/orig']);
        ...
        save(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/rhmapVals.mat'], 'mapIntensities');
        save(['/media/sf_VMShared/Reconer/reconFinished/' subject '/TP2/rhtransformVals.mat'], 'M');
        rhreformater(subject);
