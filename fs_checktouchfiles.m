function [allexist,volexist,missing_files] = fs_checktouchfiles(subj,subjdir,nonlinregflag);
%function [allexist,volexist,missing_files] = fs_checktouchfiles(subj,[subjdir],[nonlinregflag]);
%
% Required input:
...
% last mod: 05/12/10 by Don Hagler   added missing_files to diagnose problems
%
...
% these no longer produced by v450
